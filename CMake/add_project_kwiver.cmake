...
ExternalProject_Add(kwiver
  ...
  GIT_REPOSITORY "git://github.com/dmjoy/kwiver.git"
  GIT_TAG 80ffce5bf75279aebffa4be7203f6c7c88cf2d6f
  CMAKE_CACHE_ARGS
    -DKWIVER_BUILD_SHARED:BOOL=${DIVA_BUILD_SHARED_LIBS}
    -DBUILD_SHARED_LIBS:BOOL=${DIVA_BUILD_SHARED_LIBS}
    -DKWIVER_BUILT_SHARED:BOOL=${DIVA_BUILD_SHARED_LIBS}
    -Dfletch_DIR:PATH=${fletch_DIR}
    -DKWIVER_ENABLE_ARROWS:BOOL=ON
    -DKWIVER_ENABLE_BURNOUT:BOOL=OFF
    -DKWIVER_ENABLE_CERES:BOOL=OFF
    -DKWIVER_ENABLE_CUDA:BOOL=${DIVA_BUILD_WITH_CUDA}
    ...
    -DPYBIND11_PYTHON_VERSION:STRING=${DIVA_PYTHON_MAJOR_VERSION}
