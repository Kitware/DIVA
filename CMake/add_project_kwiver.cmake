...
if(SKBUILD)
  set(KWIVER_INSTALL_SETUP_SCRIPT, OFF)
else()
  set(KWIVER_INSTALL_SETUP_SCRIPT, ON)
endif()
...
ExternalProject_Add(kwiver
  ...
  CMAKE_CACHE_ARGS
    -DKWIVER_BUILD_SHARED:BOOL=${DIVA_BUILD_SHARED}
    ...
    -DKWIVER_INSTALL_SET_UP_SCRIPT:BOOL=${KWIVER_INSTALL_SET_UP_SCRIPT}
